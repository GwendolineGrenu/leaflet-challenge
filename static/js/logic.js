...
d3.json(url).then(function (data) {
    function mapStyle(feature) {
        ...
        // Establish the colors for magnitude depth
    }
    ...
    // Add the earthquakes data to the map
    L.geoJson(data, {
        ...
        // Activate the pop-up data when circles are clicked
...
// Add the legend with colors to corrolate with the depth
